...
const TEXT_RESPONSES: Record<string, string> = {
  default:
    '你好！我是 SuperK-Agent v0.15——现在支持 Plugin 动态加载了。试试 /plugin 看看已加载的插件，或者让我帮你查数据库。',
  greeting:
    '你好！我是 SuperK-Agent v0.15，支持 Plugin 扩展。试试让我查数据库或者 /plugin 管理插件 :)',
  memorySaved:
